    ...
    namespace candidate
    {
                                      ...
                                      const FingerHand &finger_hand, Hand &hand) const
        {
            ...
            int label = antipodal_.evaluateGrasp(point_list, 0.003,
                                                 ...
                                                 finger_hand.getForwardAxis(), 2, score);

            // std::cout << "setHalfAntipodal" << (label == Antipodal::HALF_GRASP || label == Antipodal::FULL_GRASP) << std::endl;
            // std::cout << "setFullAntipodal" << (label == Antipodal::FULL_GRASP) << std::endl;
